...
final class CustomSwitch: UIControl {
    ...
    @IBInspectable  public var onTintColor: UIColor = UIColor(red: 30/255, green: 144/255, blue: 255/255, alpha: 1) {
        didSet {
            self.setupUI()
    ...
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            ...
            if self.areLabelsShown {
                ...
                self.labelOff.textColor = UIColor(red: 30/255, green: 144/255, blue: 255/255, alpha: 1)
